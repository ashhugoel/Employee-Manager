...
const EmployeeCardContent = ({ name, id, address, contact, onDelete, onViewDetails }) => {

    return (
        <div className="row border-bottom align-items-center fw-bold text-black py-2 border-light">
            <div className="col-2">{name || "Name"}</div>
            <div className="col-4">{id || "ID"}</div>
            <div className="col-3">{contact.email || "Null"}</div>
            <div className="col align-self-end">
                ...
                <button onClick={() => onDelete(id)} type="button" className="btn btn-outline-danger mx-2">
